...
class EventAlertBlock extends BlockBase implements ContainerFactoryPluginInterface
{
     ...
     *   The event date service.
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, EventDateService $event_date_service, RouteMatchInterface $route_match)
    {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition)
    {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('event_alert_module.event_date_service'),
